'''
(Baseado no arquivo 02 da aula passada)
...
Modificar o programa abaixo para ter duas opções novas no menu:

- Procurar estudante por RM - 
- Remover estudante por ID - Concluído

Dica: query DELETE exige fazer conexao.commit() depois.
'''
